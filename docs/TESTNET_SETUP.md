...
For testnet, you can use a demo EVM key. The CLI repository includes helper scripts in the `testnet/` folder:
...
- Testnet helper scripts are in the `testnet/` folder:
